...
var createDir_1 = require("./createDir");
var onCreate = function (arg) {
    if (arg === void 0) { arg = { name: '' }; }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    name = result.name;
                    _a.label = 2;
                case 2: return [4 /*yield*/, (0, fs_extra_1.readdirSync)('../src/views/vuejsChallenges')
                    // 查看文件夹有没有重复创建的
                ];
                case 3:
                    dirs = _a.sent();
                    ...
                    if (!~hasCreate) return [3 /*break*/, 5];
                    return [4 /*yield*/, inquirer.prompt([
                            {
                                name: "name",
                                type: "input",
                                message: (0, kolorist_1.red)("\u00D7\u9898\u76EE" + name + "\u5DF2\u7ECF\u88AB\u521B\u5EFA\uFF0C \u8BF7\u91CD\u65B0\u8F93\u5165")
                            }
                        ])];
                case 4:
                    result = _a.sent();
