...
var creaTemplate_1 = require("./creaTemplate");
var kolorist_1 = require("kolorist");
var create_1 = require("./create");
axios_1["default"].defaults.baseURL = "https://api.github.com";
var createDir = function (name) { return __awaiter(void 0, void 0, void 0, function () {
    var res, filArr, isFindFileContent, tmplDir, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios_1["default"].get("/repos/webfansplz/vuejs-challenges/contents/questions")];
            case 1:
                res = _a.sent();
                if (res.data) {
                    filArr = res.data;
                    isFindFileContent = filArr.find(function (item) {
